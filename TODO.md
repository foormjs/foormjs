...
## redesign variant picker (for union)

display [...] next to its title/label, dropdown with variants on click.
for optional union (N/A component) - show the same dropdown on click to N/A component
...
$("object", E2eTestForm)
  .prop(
    ...
    $().designType("string")
      ...
      .annotate("foorm.fn.placeholder", "(v, data) => data.firstName ? \"Same as \" + data.firstName + \"?\" : \"Doe\"")
      .annotate("foorm.type", "text")
    ...
    $().designType("number")
      ...
      .annotate("expect.min", { minValue: 18,  message: "Must be 18 or older" })
      .$type
  ).prop(
    "email",
    $().designType("string")
      .tags("email", "string")
      .annotate("foorm.fn.label", "(v, data) => data.firstName ? data.firstName + \"s Email\" : \"Email\"")
      .annotate("foorm.fn.description", "(v, data) => data.firstName ? \"We will contact \" + data.firstName + \" here\" : \"Your email address\"")
      .annotate("foorm.type", "text")
    ...
    $().designType("string")
      ...
      .annotate("foorm.fn.hint", "(v, data) => v ? \"Nice nickname, \" + (data.firstName || \"stranger\") + \"!\" : \"Choose a cool nickname\"")
      .annotate("foorm.type", "text")
    ...
    $().designType("string")
      ...
      .annotate("foorm.type", "text")
      .annotate("foorm.fn.attr", { name: "data-valid",  fn: "(v) => v && v.length >= 10 ? \"true\" : \"false\"" }, true)
      .annotate("foorm.fn.attr", { name: "data-length",  fn: "(v) => v ? String(v.length) : \"0\"" }, true)
    ...
    $().designType("string")
      ...
      .annotate("foorm.fn.attr", { name: "data-tier",  fn: "(v, data) => data.agreeToTerms ? \"premium\" : \"basic\"" }, true)
    ...
    $().designType("string")
      ...
      .annotate("foorm.fn.description", "(v, data, ctx) => ctx.descriptions?.contextDescription || \"Fallback description\"")
      .annotate("foorm.type", "text")
    ...
    $().designType("string")
      ...
      .annotate("foorm.validate", "(v) => !v || v.length >= 3 || \"Must be at least 3 characters\"", true)
    ...
    $().designType("phantom")
      ...
      .annotate("foorm.fn.value", "(v, data) => data.firstName && data.lastName ? \"Hello, \" + data.firstName + \" \" + data.lastName + \"! You are \" + (data.age || \"?\") + \" years old.\" : \"Fill out your info above to see a summary.\"")
      .annotate("foorm.order", 21)
      .$type
  )

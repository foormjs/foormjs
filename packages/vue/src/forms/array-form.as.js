...
$("object", ArrayForm)
  .prop(
    ...
    $("array")
      ...
      .annotate("expect.maxLength", { length: 5,  message: "Maximum 5 tags" })
      .$type
  ).prop(
    "scores",
    $("array")
      ...
      .annotate("expect.maxLength", { length: 10,  message: "Maximum 10 scores" })
      .$type
  ).prop(
    "addresses",
    $("array")
      ...
      .annotate("foorm.array.remove.label", "Remove address")
      .$type
  ).prop(
    "settings",
    $("object")
    ...
    $("array")
      ...
      .annotate("foorm.array.add.label", "Add contact")
      .$type
  ).prop(
    "category",
    $().designType("string")
    ...
    $().designType("phantom")
      .tags("paragraph", "foorm")
      .annotate("foorm.fn.value", "(v, data) => data.name ? \"Project: \" + data.name + \" (\" + (data.tags || []).length + \" tags, \" + (data.addresses || []).length + \" addresses)\" : \"Enter a project name to see a summary.\"")

        ...
        $('object')
          ...
          .prop(
            ...
            $()
              ...
              .annotate(
                'foorm.fn.hint',
                '(v) => v && v.length !== 2 ? "Use a 2-letter ISO code" : ""'
              )
    ...
    $('object')
      ...
      .prop(
        ...
        $('object')
          ...
          .annotate('foorm.order', 14).$type
      )
      .annotate('foorm.order', 10).$type
  )
